...
/** Dedicated Worker 最小消息端口，避免依赖额外 WebWorker lib 全局声明。 */
interface DedicatedWorkerMessagePort {
...
const workerScope = globalThis as unknown as DedicatedWorkerMessagePort;
