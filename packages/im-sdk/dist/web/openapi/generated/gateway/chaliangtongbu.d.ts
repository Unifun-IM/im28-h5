...
export declare function postV1UpdatesGetConversationDifference(body: GatewayOpenAPI.GetConversationDifferenceRequest, options?: Record<string, unknown>): Promise<GatewayOpenAPI.GetConversationDifferenceEnvelope>;
...
export declare function postV1UpdatesGetDifference(body: GatewayOpenAPI.GetDifferenceRequest, options?: Record<string, unknown>): Promise<GatewayOpenAPI.GetDifferenceEnvelope>;
//# sourceMappingURL=chaliangtongbu.d.ts.map