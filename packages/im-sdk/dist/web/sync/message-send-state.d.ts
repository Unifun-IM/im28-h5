import { ConversationRepository, MessageRepository, type GatewayClientMessageBody, type GatewayHTTPClient, type Message } from '@im28/im-sdk/core';
...
export declare function completeWebIMMessageSend(prepared: PreparedWebIMMessageSend, body: GatewayClientMessageBody, dependencies: WebIMMessageSendDependencies): Promise<Message>;
...
export declare function executeWebIMMessageSend(context: WebIMSyncContext, definition: WebIMMessageSendDefinition, body: GatewayClientMessageBody, dependencies: WebIMMessageSendDependencies): Promise<Message>;
