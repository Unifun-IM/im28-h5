...
/** 导出消息同步契约。 */
export type { IMMessageSync, IMMessageSyncDependencies, WebIMMessageSync, WebIMMessageSyncDependencies, WebIMPullMessageHistoryOptions, WebIMPullMessageHistoryResult, } from './message-sync.js';
/** 导出当前账号消息搜索 facade。 */
...
/** 导出自定义表情同步契约。 */
export type { IMCustomEmojiSync, IMCustomEmojiSyncDependencies, WebIMCustomEmojiSync, WebIMCustomEmojiSyncDependencies, } from './custom-emoji-sync.js';
/** 导出群聊 mention 发送能力。 */
