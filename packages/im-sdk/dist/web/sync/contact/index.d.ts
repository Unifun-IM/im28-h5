...
/** 导出黑名单 facade 契约。 */
export type { IMBlacklistSync, IMBlacklistSyncDependencies, WebIMBlacklistListOptions, WebIMBlacklistSync, WebIMBlacklistSyncDependencies, WebIMBlacklistUser, } from './blacklist-sync.js';
/** 创建不复制资料或黑名单 owner 的单聊关系组合 facade。 */
export { createIMDirectChatRelationshipSync } from './direct-chat-relationship-sync.js';
/** 导出单聊关系组合 facade 的中性契约。 */
...
/** 导出通讯录 facade 契约。 */
export type { IMContactSync, IMContactSyncDependencies, WebIMContact, WebIMContactListOptions, WebIMContactSearchUser, WebIMContactSync, WebIMContactSyncDependencies, } from './contact-sync.js';
/** 创建 RN、Web、Desktop 共用的联系人写动作 facade。 */
export { createIMContactActionsSync } from './contact-actions.js';
/** 导出中性联系人写动作契约。 */
export type { IMContactActionsSync, IMContactActionsSyncDependencies, IMContactCommonGroup, IMContactFriendProfile, IMDeleteFriendOptions, IMDeleteFriendResult, IMFriendDeleteScope, IMListContactCommonGroupsOptions, IMShareGroupCardOptions, IMShareGroupCardResult, IMShareUserCardOptions, IMShareUserCardResult, } from './contact-actions.js';
...
/** 导出好友申请 facade 契约。 */
export type { IMFriendApplicationSync, IMFriendApplicationSyncDependencies, WebIMFriendApplication, WebIMFriendApplicationDirection, WebIMFriendApplicationListOptions, WebIMFriendApplicationSync, WebIMFriendApplicationSyncDependencies, } from './friend-application-sync.js';
...
/** 导出联系人资料 facade 契约。 */
export type { IMPeerProfileSync, IMPeerProfileSyncDependencies, WebIMPeerProfile, WebIMPeerProfileRelationship, WebIMPeerProfileSync, WebIMPeerProfileSyncDependencies, } from './peer-profile-sync.js';
