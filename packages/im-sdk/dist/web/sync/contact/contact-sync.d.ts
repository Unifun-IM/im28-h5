...
/** 创建只通过共享 Gateway client 读取好友列表的跨端 facade。 */
export declare function createIMContactSync(dependencies: IMContactSyncDependencies): IMContactSync;
/** 平台中立的联系人同步契约。 */
export type IMContactSync = WebIMContactSync;
/** 平台中立的联系人同步依赖。 */
export type IMContactSyncDependencies = WebIMContactSyncDependencies;
/** 兼容已发布的 Web 命名；实现与 createIMContactSync 相同。 */
export declare const createWebIMContactSync: typeof createIMContactSync;
