...
import { type IMOpenGroupConversationOptions } from '../group/group-conversation-open.js';
...
/** 创建认证账号绑定的跨端会话同步服务。 */
export declare function createIMConversationSync(dependencies: IMConversationSyncDependencies): IMConversationSync;
/** 平台中立的会话同步契约。 */
export type IMConversationSync = WebIMConversationSync;
/** 平台中立的会话同步依赖。 */
export type IMConversationSyncDependencies = WebIMConversationSyncDependencies;
/** 兼容已发布的 Web 命名；实现与 createIMConversationSync 相同。 */
export declare const createWebIMConversationSync: typeof createIMConversationSync;
