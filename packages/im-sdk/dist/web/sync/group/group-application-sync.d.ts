...
/** 创建群申请跨端 facade。 */
export declare function createIMGroupApplicationSync(dependencies: IMGroupApplicationSyncDependencies): IMGroupApplicationSync;
/** 平台中立的群申请同步契约。 */
export type IMGroupApplicationSync = WebIMGroupApplicationSync;
/** 平台中立的群申请同步依赖。 */
export type IMGroupApplicationSyncDependencies = WebIMGroupApplicationSyncDependencies;
/** 兼容已发布的 Web 命名；实现与 createIMGroupApplicationSync 相同。 */
export declare const createWebIMGroupApplicationSync: typeof createIMGroupApplicationSync;
