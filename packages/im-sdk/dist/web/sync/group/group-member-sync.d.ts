...
/** 平台中立的群成员同步契约。 */
export type IMGroupMemberSync = WebIMGroupMemberSync;
/** 平台中立的群成员同步依赖。 */
export type IMGroupMemberSyncDependencies = WebIMGroupMemberSyncDependencies;
/** 创建当前账号绑定的群成员同步 facade。 */
export declare function createIMGroupMemberSync(dependencies: IMGroupMemberSyncDependencies): IMGroupMemberSync;
/** 兼容已发布的 Web 命名；实现与 createIMGroupMemberSync 相同。 */
export declare const createWebIMGroupMemberSync: typeof createIMGroupMemberSync;
