...
export async function postV1LiveKitWebhook(body, options) {
    return request("/v1/livekit/webhook", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function postV2CallDelete(body, options) {
    return request("/v2/call/delete", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function postV2CallDetail(body, options) {
    return request("/v2/call/detail", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export async function postV2CallList(body, options) {
    return request("/v2/call/list", {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
//# sourceMappingURL=apItonghua.js.map