...
export declare function createIMRealtimeSync(dependencies: IMRealtimeSyncDependencies): IMRealtimeSync;
/** 平台中立的 realtime 同步契约。 */
export type IMRealtimeSync = WebIMRealtimeSync;
/** 平台中立的 realtime 同步依赖。 */
export type IMRealtimeSyncDependencies = WebIMRealtimeSyncDependencies;
/** 兼容已发布的 Web 命名；实现与 createIMRealtimeSync 相同。 */
export declare const createWebIMRealtimeSync: typeof createIMRealtimeSync;
