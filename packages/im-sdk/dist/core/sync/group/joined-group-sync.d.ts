...
import type { WebIMMessageSendDependencies } from '../message/message-send-state.js';
...
export declare function createIMJoinedGroupSync(dependencies: IMJoinedGroupSyncDependencies): IMJoinedGroupSync;
/** 平台中立的已加入群同步契约。 */
export type IMJoinedGroupSync = WebIMJoinedGroupSync;
/** 平台中立的已加入群同步依赖。 */
export type IMJoinedGroupSyncDependencies = WebIMJoinedGroupSyncDependencies;
/** 兼容已发布的 Web 命名；实现与 createIMJoinedGroupSync 相同。 */
export declare const createWebIMJoinedGroupSync: typeof createIMJoinedGroupSync;
