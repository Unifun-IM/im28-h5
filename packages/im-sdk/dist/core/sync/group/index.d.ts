...
/** 导出当前账号的群列表契约。 */
export type { IMJoinedGroupSync, IMJoinedGroupSyncDependencies, IMPublishWebIMGroupAnnouncementOptions, IMPublishWebIMGroupAnnouncementResult, WebIMJoinedGroup, WebIMJoinedGroupRole, WebIMJoinedGroupStatus, WebIMJoinedGroupSync, WebIMJoinedGroupSyncDependencies, WebIMJoinedGroupSyncOptions, } from './joined-group-sync.js';
/** 导出群模式归一化能力。 */
...
/** 导出群成员同步契约。 */
export type { IMGroupMemberSync, IMGroupMemberSyncDependencies, WebIMGroupMember, WebIMGroupMemberRole, WebIMGroupMemberSync, WebIMGroupMemberSyncDependencies, WebIMGroupMemberSyncOptions, } from './group-member-sync.js';
/** 导出群成员与提及 facade。 */
export { createIMGroupMentionSync } from './group-mention.js';
/** 导出群成员与提及契约。 */
export type { IMGroupAdminChangeResult, IMGroupMentionMember, IMGroupMentionSync, IMGroupMentionSyncDependencies, IMGroupOwnerTransferResult, IMInviteGroupMembersResult, IMRemoveGroupMembersResult, IMSendGroupMentionOptions, } from './group-mention.js';
/** 导出群成员邀请能力。 */
