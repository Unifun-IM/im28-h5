...
import { createIMGroupMemberSync, } from './group-member-sync.js';
import { inviteIMGroupMembers, } from './group-member-invitation.js';
import { removeIMGroupMembers, } from './group-member-removal.js';
import { sendWebIMMentionMessage, } from '../message/message-mention-send.js';
...
export function createIMGroupMentionSync(dependencies) {
    ...
    const memberSync = createIMGroupMemberSync(sharedDependencies);
    return {
