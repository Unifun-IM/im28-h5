...
export interface WebIMPeerProfileSync {
    ...
    applyFriend(userID: string, message?: string): Promise<void>;
}
...
export declare function createWebIMPeerProfileSync(dependencies: WebIMPeerProfileSyncDependencies): WebIMPeerProfileSync;
