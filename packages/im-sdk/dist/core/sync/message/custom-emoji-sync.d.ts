...
/** 创建认证账号绑定的自定义表情同步服务。 */
export declare function createIMCustomEmojiSync(dependencies: IMCustomEmojiSyncDependencies): IMCustomEmojiSync;
/** 平台中立的自定义表情同步契约。 */
export type IMCustomEmojiSync = WebIMCustomEmojiSync;
/** 平台中立的自定义表情同步依赖。 */
export type IMCustomEmojiSyncDependencies = WebIMCustomEmojiSyncDependencies;
/** 兼容已发布的 Web 命名；实现与 createIMCustomEmojiSync 相同。 */
export declare const createWebIMCustomEmojiSync: typeof createIMCustomEmojiSync;
